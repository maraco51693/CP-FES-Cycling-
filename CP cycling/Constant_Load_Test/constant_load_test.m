function varargout = constant_load_test(varargin)
% CONSTANT_LOAD_TEST M-file for constant_load_test.fig
%      CONSTANT_LOAD_TEST, by itself, creates a new CONSTANT_LOAD_TEST or raises the existing
%      singleton*.
%
%      H = CONSTANT_LOAD_TEST returns the handle to a new CONSTANT_LOAD_TEST or the handle to
%      the existing singleton*.
%
%      CONSTANT_LOAD_TEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CONSTANT_LOAD_TEST.M with the given input arguments.
%
%      CONSTANT_LOAD_TEST('Property','Value',...) creates a new CONSTANT_LOAD_TEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before constant_load_test_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to constant_load_test_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help constant_load_test
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @constant_load_test_OpeningFcn, ...
                   'gui_OutputFcn',  @constant_load_test_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before constant_load_test is made visible.
function constant_load_test_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to constant_load_test (see VARARGIN)

% Choose default command line output for constant_load_test
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes constant_load_test wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = constant_load_test_OutputFcn(hObject, eventdata, handles) 
