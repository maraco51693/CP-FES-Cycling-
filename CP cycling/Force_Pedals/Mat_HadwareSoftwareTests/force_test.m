function varargout = force_test(varargin)
% FORCE_TEST M-file for force_test.fig
%      FORCE_TEST, by itself, creates a new FORCE_TEST or raises the existing
%      singleton*.
%
%      H = FORCE_TEST returns the handle to a new FORCE_TEST or the handle to
%      the existing singleton*.
%
%      FORCE_TEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FORCE_TEST.M with the given input arguments.
%
%      FORCE_TEST('Property','Value',...) creates a new FORCE_TEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before force_test_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to force_test_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help force_test

% Last Modified by GUIDE v2.5 21-Jul-2010 15:47:33

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @force_test_OpeningFcn, ...
                   'gui_OutputFcn',  @force_test_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before force_test is made visible.
function force_test_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to force_test (see VARARGIN)

% Choose default command line output for force_test
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes force_test wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = force_test_OutputFcn(hObject, eventdata, handles) 
