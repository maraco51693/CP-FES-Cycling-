/* 
  sf_metamax.c
  S-Function for data connection to MetaMax 3B with win32
  
  To compile as a mex function use 
  mex sf_metamax.c  metamax_lib.c serial_w32.c

  For use with the RTW, the additional libs must be set as
  set_param('name-of-SFunction','SFunctionModules','metamax_lib serial_w32')
 */ 
 
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME  sf_metamax
...
/*
  datacollection_thread()
  Thread for communication with serial line interface.
 */
static void datacollection_thread()
{
  BOOL fSuccess=0;
  char port[4];
