...
% ==========================================
% Begin:
text(0.5, 0.9, 'Stimulation Frequency', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');

plot([0.05 0.95], [0.65 0.65]);
plot([0.35 0.35], [0.8 0.2]);
plot([0.65 0.65], [0.8 0.2]);

text(0.2, 0.7, 'Muscle', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'middle');
